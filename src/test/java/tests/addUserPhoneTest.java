...
@DataLoader(filePaths = "addUserPhoneTestData.csv")
public class addUserPhoneTest {
    ...
    @Test
    public void testAddUserPhone(@Param(name="type")String type, @Param(name="contact")String contact, @Param(name="expectedMessage")String expectedMessage)
    {
        taskit.login()
                .wait(3)
